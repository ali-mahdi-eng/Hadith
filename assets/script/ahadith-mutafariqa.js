...
function copyToClipboard(currentHadith) {
    let textToCopy = currentHadith.substring(0, currentHadith.lastIndexOf("المصدر"));
    let sourceToCopy = currentHadith.substring(currentHadith.lastIndexOf("المصدر"));
    let copyText = `${textToCopy} \n\n ${sourceToCopy}`;
